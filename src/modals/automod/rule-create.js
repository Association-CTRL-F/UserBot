export default {
	...
	interaction: async (modal, client) => {
		...
		try {
			const sqlInsert =
				'INSERT INTO automod_rules (guildId, customId, regex, type, ignoredRoles, reason) VALUES (?, ?, ?, ?, ?, ?)'
			const dataInsert = [modal.guild.id, customId, regex, type, ignoredRoles, reason]
